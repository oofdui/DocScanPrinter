...
Public Class frmDefault
    ...
    Private Sub frmDefault_FormClosed(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosedEventArgs) Handles Me.FormClosed
        frmLogin.Close()
    End Sub
    ...
    Private Sub btSearch_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btSearch.Click
        ...
        If dtpFrom.Checked = True And dtpTo.Checked = True Then 'เลือกช่วงวัน
            ...
            Else
                strSearch &= "WHERE "
            End If
            strSearch &= "(CF.scannow BETWEEN '" & dtpFrom.Value.Date & "  00:00:00' AND '" & dtpTo.Value.Date & "  23:59:59') "
        ElseIf dtpFrom.Checked = True And dtpTo.Checked = False Then 'เลือกวันเริ่มต้น
            ...
            Else
                strSearch &= "WHERE "
            End If
            strSearch &= "CF.scannow >= '" & dtpFrom.Value.Date & " 00:00:00' "
        ElseIf dtpFrom.Checked = False And dtpTo.Checked = True Then 'เลือกวันสิ้นสุด
            ...
            Else
                strSearch &= "WHERE "
            End If
            strSearch &= "CF.scannow <='" & dtpTo.Value.Date & " 23:59:59' "
        End If
    ...
    Private Sub btClose_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btClose.Click
        If frmAuto.Timer1.Enabled = True Then
            Me.Hide()
            frmAuto.Show()
        Else
            Me.Close()
    ...
    Private Sub pnLoading_VisibleChanged(ByVal sender As Object, ByVal e As System.EventArgs) ' Handles pnLoading.VisibleChanged
        If pnLoading.Visible = True Then
            Dim i As Integer = 0
            For i = 0 To 1000
                'pnLoading.Refresh()
                If pnLoading.Visible = False Then
                    Exit For
                End If
            Next
        End If
    ...
    Private Sub BackgroundWorker1_DoWork(ByVal sender As System.Object, ByVal e As System.ComponentModel.DoWorkEventArgs) Handles BackgroundWorker1.DoWork
        ...
        "FROM mdr_cardfiles As CF " & _
             "LEFT JOIN mdr_patient AS PT ON CF.hn=PT.hn " & _
             "LEFT JOIN mdr_careprovidor AS CP ON CF.doctorcode=CP.code " & _
             "LEFT JOIN mdr_location As LO ON CF.locationcode=LO.code " & _
             "INNER JOIN mdr_docgroup As DG ON CF.docgrp=DG.code " & _
             "INNER JOIN mdr_docsubgroup As DS ON CF.docgrp=DS.code AND CF.docsubgrp=DS.subcode "
        strSql &= strSearch
        strSql &= "ORDER BY scannow DESC"
